...
//    struct ifreq ifr;
//
//    if (ifname) bip_set_interface(ifname);
//    else bip_set_interface("eth0");
//
...
//    sockopt = 1;
//    status = setsockopt(sock_fd, SOL_SOCKET, SO_REUSEADDR, &sockopt, sizeof(sockopt));
//    if (status < 0)
//        {
//        close(sock_fd);
//        bip_set_socket(-1);
...
//    status = setsockopt(sock_fd, SOL_SOCKET, SO_BROADCAST, &sockopt, sizeof(sockopt));
//    if (status < 0)
//        {
//        close(sock_fd);
//        bip_set_socket(-1);
